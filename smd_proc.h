...
SMD_API process_weak int process_create(const char *const command_line[], int options,
...
SMD_API process_pure process_weak FILE *
...
/// NULL).
/// @return On success 0 is returned.
SMD_API process_weak int process_join(struct process_s *const process,
...
/// the parent process.
SMD_API process_weak int process_destroy(struct process_s *const process);

#ifdef SMD_PROCESS_IMPL
